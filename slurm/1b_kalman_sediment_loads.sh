...
# I believe this script was necessary because the number of arrays
# was set incorrectly in original run.
...
#SBATCH --array=1-252                    # Array range, must match N_ARRAY
...
PROJECT_PATH=/lustre/projects/water/cmwsc/thodson/nrec
...
srun -N1 -n1 Rscript $R_PATH/1b_kalman_sediment_loads.R $DB $PROJECT_PATH $run $SEED
#srun -N1 -n1 Rscript $R_PATH/yeti_2_other_trends.R $DB $PROJECT_PATH $run 2008 2017 $SEED
